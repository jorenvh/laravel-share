...
class TelegramShareTest extends TestCase
{
    ...
    public function it_can_generate_a_telegram_share_link_with_all_extra_options()
    {
        $result = ShareFacade::page('https://codeswitch.be', 'Meet Joren Van Hocht a php developer with a passion for laravel', ['class' => 'my-class', 'id' => 'my-id'], '<ul>', '</ul>')
            ->telegram();
        $expected = '<ul><li><a target="_blank" href="https://telegram.me/share/url?url=https://codeswitch.be&text=Meet+Joren+Van+Hocht+a+php+developer+with+a+passion+for+laravel" class="social-button my-class" id="my-id" title=""><span class="fa fa-telegram"></span></a></li></ul>';
    ...
    public function it_can_generate_a_telegram_share_link_with_all_extra_options_with_fa5()
    {
        ...
        $result = ShareFacade::page('https://codeswitch.be', 'Meet Joren Van Hocht a php developer with a passion for laravel', ['class' => 'my-class', 'id' => 'my-id'], '<ul>', '</ul>')
            ->telegram();
        $expected = '<ul><li><a target="_blank" href="https://telegram.me/share/url?url=https://codeswitch.be&text=Meet+Joren+Van+Hocht+a+php+developer+with+a+passion+for+laravel" class="social-button my-class" id="my-id" title=""><span class="fab fa-telegram"></span></a></li></ul>';
