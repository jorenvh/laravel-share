...
class LinkedinShareTest extends TestCase
{
    ...
    public function it_can_generate_a_linkedin_share_link_with_all_extra_options()
    {
        $result = ShareFacade::page('https://codeswitch.be', 'Title', ['class' => 'my-class my-class2', 'id' => 'linkedin-share', 'title' => 'My Title for SEO'], '<ul>', '</ul>')
            ->linkedin('A summary can be passed here');
        $expected = '<ul><li><a href="http://www.linkedin.com/shareArticle?mini=true&url=https://codeswitch.be&title=Title&summary=A+summary+can+be+passed+here" class="social-button my-class my-class2" id="linkedin-share" title="My Title for SEO"><span class="fa fa-linkedin"></span></a></li></ul>';
    ...
    public function it_can_generate_a_linkedin_share_link_with_all_extra_options_with_fa5()
    {
        ...
        $result = ShareFacade::page('https://codeswitch.be', 'Title', ['class' => 'my-class my-class2', 'id' => 'linkedin-share', 'title' => 'My Title for SEO'], '<ul>', '</ul>')
            ->linkedin('A summary can be passed here');
        $expected = '<ul><li><a href="http://www.linkedin.com/shareArticle?mini=true&url=https://codeswitch.be&title=Title&summary=A+summary+can+be+passed+here" class="social-button my-class my-class2" id="linkedin-share" title="My Title for SEO"><span class="fab fa-linkedin"></span></a></li></ul>';
